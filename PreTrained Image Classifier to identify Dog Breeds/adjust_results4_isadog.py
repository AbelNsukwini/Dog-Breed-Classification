...
def adjust_results4_isadog(results_dic, dogsfile):
    ...
    # Reads in dognames from file, one name per line and automatically closes file
    with open(dogsfile, "r") as infile:
        ...
        while line != "":
            ...
            # adds dogname to dogsnames_dic if it doesn't  exist in dic
    ...
    for key in results_dic:
        ...
        # Pet Image Label is a Dog image 
        else:
            # Classifier Label is image of Dog 
